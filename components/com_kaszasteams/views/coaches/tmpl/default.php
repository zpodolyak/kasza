...
foreach($this->items as $i => $item): ?>
	...
	<div><a href="<?php echo $item->cid; ?>">
		<span style="float:left;font-weight:bold;font-size:12px;width:100%"><?php echo $item->cname; ?></span>
		</a></div>
		<div style="float:left;width:38%"><a href="<?php echo $item->cid; ?>">
			<span style="clear:left;width=100%"></span>
			<img style="float:left;padding:5px 5px 0 5px;" src="<?php echo KaszasoklibPaths::ProfilePics . $item->picture; ?>" border="0" width="50" height="75" alt="<?php echo $item->cname; ?>" /></a>
